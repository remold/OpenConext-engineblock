...
>>>>>>> remotes/remote/develop
    ...
    'answer_security'                   =>      '<p>Your organization and OpenConext believe that user privacy is extremely important.<br />
<br />
Personal details are only provided to a service provider if these details are needed to use the service. Contractual agreements between your organization and the service provider guarantee that your personal details will be handled and processed with care.<br />
<br />
...
>>>>>>> remotes/remote/develop
    ...
    'answer_screen'                     =>      '<p>You can log in to this service with your organizational account. In this screen, you select the organization you are affiliated with.</p>',
    'question_institution_not_listed'   =>      'My organization is not listed. What should I do?',
    'answer_institution_not_listed'     =>      '<p>If your organization is not listed, then it is either not linked to OpenConext or your organization may not allow access to this particular service. Go back to the page for the service. In some cases, there will be alternative ways of logging in.</p>',
    'question_institution_no_access'    =>      'My organization does not allow access to the service. What should I do?',
    'answer_institution_no_access'      =>      '<p>It is possible that your organization is connected to OpenConext but has not (or not yet) made any arrangements with the service provider about the use of the service. We will forward your request to your organization. Based on your request your organization may consider to add this service to its service portfolio.</p>',
    'question_asked_institution_access'  =>      'I have asked my organization for access but I still cannot get access. Why not?',
    'answer_asked_institution_access'    =>      '<p>Apparently, your organization has not arranged a license yet or, access to this service is not on the roadmap of your organization. Such decisions are beyond the scope and control of OpenConext.</p>',
    'question_cannot_select'            =>      'In my browser I cannot select my organization. What should I do?',
    'answer_cannot_select'              =>      '<p>The dialog box to select your organization can be used in most popular browsers, including Internet Explorer, Firefox, Chrome, and Safari. Other browsers may not be supported. Your browser must support the use of cookies and JavaScript.</p>',
...
>>>>>>> remotes/remote/develop
    ...
    'send_confirm_desc'     => '<p>Your request has been forwarded to your organization. Further settlement and decisions on the availability of this service will be taken by the ICT staff of your organization.</p>

    <p>OpenConext has forwarded your request, but the decision and planning to make this service available depends on the ICT policy of your organization.</p>
...
<<<<<<< HEAD
    ...
    'profile_header_leave_surfconext'   => 'Leave OpenConext',
    'profile_store_info'                => 'The following profile data have been provided by your home organization. This profile will be stored in (and used by) OpenConext. It is also possible that a subset of this information is provided to services that you accessed via OpenConext.',
    ...
    'profile_leave_surfconext_desc'     => 'You currently use OpenConext to access one or more applications with your organizational account. It is possible to delete your OpenConext profile by pressing the button below.',
    'profile_leave_surfconext_link'     => 'Delete my OpenConext account!',
    'profile_leave_surfconext_disclaim' => 'Note:
                                            <ul>
                                                <li>Only information stored in the OpenConext service will be deleted.</li>
...
>>>>>>> remotes/remote/develop
    ...
    'error_help_desc'               => 'If this does not solve your problem, please visit
        <a href="https://www.openconext.org/documentation">the OpenConext website </a>
        or contact the helpdesk at <a href="mailto:help@demo.openconext.org">help@demo.openconext.org</a>.',
...
<li>share your information</li></ul>',
    ...
    'error_unknown_service_provider_desc'     => '<p>
        A Service Provider with the EntityID you have provided could not be found. If you feel this is an error please contact the  helpdesk at <a href="mailto:help@demo.openconext.org">help@demo.openconext.org</a>.
    </p>',
...
>>>>>>> remotes/remote/develop
    ...
    'error_missing_required_fields_desc'=> '<p>
        You can not use this application because your organization is not providing the needed information.
    </p>
    <p>
        Please contact your organization with the information stated below.
    </p>
    <p>
        Login failed because the organization\'s identity provider did not provide OpenConext with one or more of the following required attribute(s):
        <ul>
            <li>UID</li>
    ...
    'error_group_oauth_desc'       => '<p>
        ...
        <p>Please contact the SURFconext team at <a href="mailto:help@demo.openconext.org">help@demo.openconext.org</a>.
       </p>',
...
<<<<<<< HEAD
    ...
    'idp_debugging_mail_button' => 'Mail to OpenConext',
